...
In line with its requirement to detect Earth-sized planets in a \SI{1}{\year} orbit around Sun-like stars, \plato\ is designed to enable the detection of a \SI{80}{\ppm} transit signal~\citep[][Matuszewski et al., in prep.]{plato2017}.
