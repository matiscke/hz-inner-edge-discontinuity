...
Astronomical observations of planets that are currently in the super-runaway phase may thus constrain properties of their mantles and establish an observational connection between exoplanetary interior and atmospheres~\citep{2022arXiv220310023L,Wordsworth2022}.
...
We then perform a parameter study to explore which trades in the survey design of a \plato-like mission maximizes its diagnostic power to test runaway greenhouse climate models through the detection of the habitable zone inner edge discontinuity.
