...
Due to the inherent detection biases of the transit technique, the currently best-probed regime of rocky exoplanets with a bulk density approaching that of Earth is that of hot or warm, close-in planets \citep{2019AREPS..47..141J,2021JGRE..12606639B}.
...
Studies of the geophysical state and evolution of hot exoplanets can thus contribute to our understanding of the early formation stages of Earth and other habitable worlds \citep{Lichtenberg2022,2022arXiv220310056K}.
...
While having accreted from the same mass reservoir~\citep{Morbidelli2012} and despite their similar bulk properties, they evolved into planets with very different environmental conditions on their surfaces~\citep{Kasting1988,Hamano2013,Kane2014,Turbet2021} (Donahue et al. 1982; Bézard, B. \& de Bergh, 2007; Way et al. 2016; Way \& Del Genio 2020; ).
At the formation of the Solar System, both planets underwent a giant impact phase~\citep{2020NatGe..13..265G} that melted their mantles, leading to a magma ocean stage~\citep{2012AREPS..40..113E,2018RSPTA.37680109S}.
Magma ocean states play a substantial role in establishing the geophysical and climatic regimes of rocky planets, because atmospheric volatiles are highly soluble in magmatic liquids \citep{2021ApJ...909L..22K,Dorn2021}.
...
However, no late desiccation needs to be invoked if a strongly infrared-absorbing, condensable species such as water is present on the planet.
Once the incident stellar flux exceeds a threshold value, a non-linear transition from mixed condensed and volatile to a pure volatile state occurs, and the resulting massive steam atmosphere limits the outgoing radiation from the (molten) planetary surface~\citep{Ingersoll1969,Kasting1988,2013NatGe...6..661G,2015ExA....40..449L}.
This runaway greenhouse state prevents the planet's rapid cooling and can extend the magma ocean stage to hundreds of \SI{}{\mega\year}, enough to remove the entire water reservoir from a rocky planet by H$_2$O photolysis and subsequent hydrodynamic escape of hydrogen. CITE
...
Venus' atmospheric composition is consistent with the planet having gone through this phase, although the past presence of a Venusian water ocean has not been definitely established~\citep{Raymond2006,Raymond2007,Hamano2013,Way2016}.
...
Of particular relevance is that the radiation-induced transition between a runaway greenhouse state and a temperate climate is thought to occur at a relatively sharp threshold instellation~\citep{Hamano2013}. CITE
Consequently, the instellation at which the runaway greenhouse transition occurs is aptly considered to be the inner boundary of the habitable zone, whose prevalent definition refers to the possibility of liquid water on an Earth-like planet with a CO$_2$/H$_2$O/N$_2$ atmosphere~(\citealp[][but other definitions have been put forward, e.g., ]{Kasting1993,Kopparapu2013,Kopparapu2014} \citealp{Hall2023,Spinelli2023}).
The fundamental concept of a habitable zone dates back centuries~\citep{Newton1687,Whewell1853,Shapley1953,Huang1959}, and its modern form has proven popular in the planetary literature\footnote{At the time of writing, a search of the term ``habitable zone'' in the titles and abstracts of refereed articles in NASA's Astrophysics Data System returned $\sim\num{1700}$ results.}.
Investigating its boundaries in parameter space has helped improve our understanding of habitability. CITE
Nevertheless, it should be emphasized that the habitable zone, as it stands today, is solely a concept based on theoretical predictions, and its validity continues to be debated~\citep[e.g.,][]{Cockell2016,Moore2017}.
The question naturally emerges if a habitable zone -- in its common form as boundaries in receiving instellation -- indeed exists and how the habitable zone hypothesis can be tested.
...
Section~\ref{sec:met_baseline} introduces our baseline model produce synthetic star and planet samples.
    In Sect.~\ref{sec:met_rghmodel}, we describe the model component that produces runaway greenhouse-induced radius changes.
    Section~\ref{sec:met_surveys-hypotests} explains our survey simulations and hypothesis tests.
    We present our results in Sect.~\ref{sec:results} before interpreting them in Sect.~\ref{sec:discussion}.
    Finally, we summarize our findings in Sect.~\ref{sec:conclusions}.
\end{note}
...
While the actual instellation threshold for a runaway climate depends on planetary albedo, surface gravity, and clouds~\citep{Turbet2021,Pierrehumbert2022}, this value was found to be a typical limit for the flux a planet can emit in a runaway greenhouse situation~\citep{Abe1988,Kasting1988,Nakajima1992,Goldblatt2013,Leconte2013,Boukrouche2021}.
