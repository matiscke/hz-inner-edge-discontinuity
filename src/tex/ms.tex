...
% Abstract
\begin{abstract}
Long-term magma ocean phases on rocky exoplanets orbiting inside of the runaway greenhouse transition -- the inner edge of the classical habitable zone -- may offer insights into the physical and chemical processes that distinguish potentially habitable worlds from others.
Thermal stratification of super-runaway planets is expected to significantly inflate their transit radii, potentially providing observational access to the runaway greenhouse transition in the form of a ``habitable zone inner edge discontinuity'' in radius/density space.
...
We determine survey strategies that optimize the statistical power of the obtained data, and we identify as key mission design drivers: 1. A follow-up campaign of planetary mass measurements and 2. The fraction of low-mass stars in the target sample.
Observational constraints on the runaway climate transition will provide crucial insights into the distribution of atmospheric volatiles among rocky exoplanets and inform us about which stars harbor the nearest potentially habitable worlds.
\end{abstract}
...
The net absorbed stellar fluxes of planets are sensitive on their albedos, which are generally poorly constrained for planets outside the Solar System~\citep[e.g.,][]{Angerhausen2015,Parmentier2018a,Mansfield2019b}.
...
Similar science objectives are pursued by the Large Interferometer For Exoplanets~\citep[\life,][]{Quanz2022}, a mission concept utilizing a space-based mid-infrared nulling interferometer.
...
T.L.\ provided expertise on runaway greenhouse climates.
