...
%Because hydrodynamic escape driven by stellar XUV decreases with time, the solidification timescale can become comparable to the main-sequence lifetime of the star with a sufficient water inventory~\citep{2013Natur.497..607H,Hamano2015,2022arXiv220310023L}.
...
We tested the detectability of the habitable zone inner edge discontinuity when only FGK or only M~dwarfs are considered (see Fig.~\ref{fig:plato_fgrid}).
...
This can be different for young host stars when their ages cannot be well constrained; in particular, the long pre-main sequence phase of M~dwarfs shows a large variation in bolometric luminosity~(see Fig.~\ref{fig:luminosity_tracks}).
...
The models in this study do not take into account a predicted additional radius increase on the percent level due to a molten interior~\citep{Bower2019}, and we neglect any potential effects stemming from a deviating gas exchange between atmosphere and interior in super-runaway greenhouse planets due to different redox conditions~\citep{Ikoma2018,2021JGRE..12606711L,2022PSJ.....3...93B,2021SSRv..217...22G}.
...
This can be considered a conservative choice that is unlikely to introduce a systematic overestimation of the habitable zone inner edge discontinuity, also since the hypothesis tests are only marginally sensitive on $x_\mathrm{H_2O}$ as long as it is $\gtrsim 10^{-4}$ (see Sect.~\ref{sec:res_testability}).
...
They might not contribute to the habitable zone inner edge discontinuity, although a similar transition was suggested for water-dominated sub-Neptunes~\citep{Pierrehumbert2022}.
...
All of the above mechanisms may dilute the demographic imprint of the runaway greenhouse transition with contributions that are challenging to quantify.
