...
% Abstract
\begin{abstract}
Long-term magma ocean phases on rocky exoplanets orbiting within the runaway greenhouse regime -- the inner edge of the classical habitable zone -- may offer insights into the physical and chemical processes that distinguish potentially habitable worlds from others.
...
We find that the demographic imprint from super-runaway climates is likely detectable with high-precision transit photometry for planet samples of size $\gtrsim$~100 if at least \SI{\sim 10}{\percent} of planets inside of the habitable zone inner edge harbor super-runaway climates.
...
Observational constraints on the runaway climate transition will provide crucial insights into the distribution of atmospheric volatiles among low-mass exoplanets and inform us about which stars harbor the nearest potentially habitable worlds.
\end{abstract}
