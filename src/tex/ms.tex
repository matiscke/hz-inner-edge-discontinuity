...
Figure~\ref{fig:plato_fgrid} shows that investigating the habitable zone inner edge discontinuity is more constraining when radius measurements can be augmented with mass measurements: At unchanged sample size, the difference in Bayesian evidence can be up to an order of magnitude larger.
