...
\rev{Data sets associated with this work are available at \dataset[doi:10.5281/zenodo.7080391]{\doi{10.5281/zenodo.7080391}}~(stellar luminosity tracks from \citealt{Baraffe1998}) and \dataset[doi:10.5281/zenodo.7946446]{\doi{10.5281/zenodo.7946446}} (results from model grid runs of \bioverse).}
...
Focusing on the detectability of the statistical runaway greenhouse signal and the ability to constrain the threshold instellation, we repeated the hypothesis test in Sect.~\ref{sec:res_testability} with alternative mass–radius relationships.
