...
%    \script{figurescript.py}
    ...
    As long as $f_\mathrm{rgh}$ is larger than $\sim 0.1$, a sample size of \var{N_optimistic} is sufficient for a $\SI{50}{\percent}$ detection rate even for water ratios as low as $x_{H_2O} = 0.001$.
\end{note}
