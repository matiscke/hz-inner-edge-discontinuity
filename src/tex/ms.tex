...
\begin{note}
    ...
    To test the detectability of a magma ocean signature, we simulated several transit surveys with different designs and strategies and explored their ability to recover the magma ocean trend and constrain its parameters.
