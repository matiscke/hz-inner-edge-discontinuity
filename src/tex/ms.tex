...
In a super-runaway state the atmosphere is dominated by the opacity of water vapor, which has two prominent spectral features: one at 3.5--4.5 $\mu$m, and one between 8--20 $\mu$m~\citep[e.g.][]{2021ApJ...919..130B}.
...
(ii) Post-runaway planets may be detectable by O$_{3}$ absorption due to build-up of abiotic oxygen, left-over from photochemical dissociation, and hydrogen loss~\citep{2014ApJ...785L..20W,2015AsBio..15..119L}.
...
The magnitude of the radius inflation effect is in fact expected to be larger for an Earth-like interior composition with an iron core-silicate mantle structure~\citep[][, add Noack+ paper]{2016ApJ...819..127Z,2021JGRE..12606724B}. CITE!
