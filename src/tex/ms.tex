...
\begin{figure}
    \begin{centering}
        ...
        \textit{Bottom}: Radii of synthetic planets with injected radius deviation as a function of net instellation. Only the planets marked as transiting are observable.
            Above the runaway greenhouse threshold $S_\mathrm{thresh} =\SI{280}{\watt\per\meter\squared} $, some planets maintain their original radii (green crosses) whereas some have their radii inflated (blue crosses) by the amount indicated with gray lines.
...
Ultimately, such measurements will shed light on the question of whether planets like Earth received their water from primordial sources during their formation or whether it was supplied later~\citep[e.g.,][]{Raymond2004}.
