...
\todo[inline]{papers: \citet{Hamano2013,Barth2021,Downey2022}. \citep[][water loss, O2 buildup around M dwarfs]{Luger2015}, }
...
\todo[inline]{GALEN: Describe underlying planet occurrence rates of synthetic population, its Mstar dependency, any caveats or assumptions. Probably replace SAG13-based content below.}
\begin{note}
...
\begin{note}
    ...
    In this study, we consider only rocky planets with a maximum mass of \SI{2}{\Mearth}. % (Turbet+2020 goes only up to 2 Mearth)
    ...
    \todo[inline]{JUSTIFY this choice}
...
\todo{Introduce survey simulation(s). PLATO, Cheops, Ariel, LIFE?, Nautilus\\ What are threshold missions that are able to detect this signal? =>X meter working for Y years, or X' meter working for Y' years => conclusion could be that there is interesting science to do with intermediate size telescope.}
\begin{note}
...
%The authors thank Paul Molliere, Arnaud Salavdor, and Terry-Ann Suer for insightful discussions.
%We are grateful to Martin Turbet for providing the mass-radius relationship data.
