...
For a transit signal to be detected in a transit survey, it must reach a sufficient signal-to-noise ratio (S/N) that is sensitive on the achieved photometric precision~\citep[e.g.,][]{Burke2015,Hardegree-Ullman2019}.
