...
\todo[inline]{elaborate based on Sect.~\ref{sec:res_constrain-S_thresh}}
...
\todo[inline]{discuss additional measurements that could lift the degeneracy. e.g., adding atmospheric compositional information i.e., PLATO + ARIEL or similar}
