...
> We cite this clearly relevant paper in Section 6.2.3. Atmospheric spectral signatures and added a sentence on potentially distinguishing different climate regimes, for example the bistable moist state identified in the paper, through additional spectrally resolved observations. 
